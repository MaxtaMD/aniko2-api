 ...
 * Used to proxy m3u8 streams and subtitle files.
 * Set CF_PROXY_URL env var to override.
 */
export const CF_PROXY_URL =
  process.env.CF_PROXY_URL ?? 'https://aniko2-api.privaterun2.workers.dev';
